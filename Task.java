...
public class Task {
    public static void main(String[] args) {
        ...
        System.out.println("4. Check the number is positive or not");
        choice = scanner.nextInt();

        switch (choice) {
            case 1://checking the number even or odd
                int num;
            ...
            case 3:
                ...
                else if(age < 50 && age > 20)   // in range of age in between 21 to 49
                {
                    accountBalance = principalAmount * Math.pow((1 + (3/100)), numberOfYears);
                    System.out.println("Account balance after " + numberOfYears + " years: " + accountBalance);
                }
                else    //below 20 are not eleigible
